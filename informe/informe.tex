...
% Tamaño de bloque fijo (B = 4096 / 8192 bytes), manejo de seek()/struct/binario.
% Estructura del Page Header y tuplas/RID.

\subsection{Instrumentación de E/S (DiskCounter)}
% Monitor para el registro estricto de disk_reads y disk_writes.
